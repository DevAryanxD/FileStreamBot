...
class Telegram:
    ...
    MULTI_CLIENT = False
    FLOG_CHANNEL = int(env.get("FLOG_CHANNEL", "-1002632246955"))   # Logs channel for file logs
    ULOG_CHANNEL = int(env.get("ULOG_CHANNEL", "-1002632246955"))   # Logs channel for user logs
...
class Server:
    ...
    BIND_ADDRESS = str(env.get("BIND_ADDRESS", "95.217.140.19"))
